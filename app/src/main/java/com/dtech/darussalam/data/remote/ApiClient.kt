...
import com.dtech.darussalam.BuildConfig
        ...
        if (retrofit == null) {
            retrofit = Retrofit.Builder().client(OkHttpClient().newBuilder().readTimeout(60, TimeUnit.SECONDS)
                ...
                val newRequest = chain?.request()!!.newBuilder()
                    ...
                    newRequest.addHeader("app-version" , BuildConfig.VERSION_NAME)
                   // newRequest.addHeader("lang" , DoneApp.db.getString(Constants.LANGUAGE , Constants.ENGLISH)!!)
