package com.dtech.darussalam.view.base
...
import com.dtech.darussalam.utilities.extensions.setAppLocale
...
open class BaseFragment : Fragment() {
    ...
    fun addFragment(containerId: Int, fragment: Fragment, tag: String?) {
        ActivityBase.activity.setAppLocale()
    ...
    override fun onDestroyView() {
        ...
        when (ActivityBase.activity) {
         /*   is MainActivity -> {
           ...
           /* is ProviderMainActivity -> {
                (ActivityBase.activity as ProviderMainActivity).checkVisibleFragment()
            }*/
        }
    }
