...
import com.dtech.darussalam.data.remote.ApiClient
import com.dtech.darussalam.data.remote.ApiInterface
import com.dtech.darussalam.utilities.Constants
import com.dtech.darussalam.utilities.helper.TinyDB
...
class DarusslamApp : Application() {
    private lateinit var appSharedPrefs: SharedPreferences
    private lateinit var prefsEditor: SharedPreferences.Editor
    private var SHARED_NAME = "com.dtech.darussalam.app"
...
//            context.InternetSpeedChecker()
    ...
    companion object {
        ...
        private var instance: DarusslamApp? = null

        @SuppressLint("StaticFieldLeak")
        lateinit var context: Context
        private val TAG = DarusslamApp::class.java.name
